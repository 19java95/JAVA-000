package top.tangtian.geek_week0701.config;
 ...
 **/
@Configuration
@MapperScan(basePackages = "top.tangtian.geek_week0701.mapper.master", sqlSessionFactoryRef = "masterSqlSessionFactory")
public class MasterMybatisConfig {
    ...
    public SqlSessionFactory masterSqlSessionFactory(@Qualifier("master") DataSource dataSource) throws Exception {
        ...
        //对应数据库的entity位置
        String typleAliasesPackage = "top.tangtian.geek_week0701.entity.master";

 ...
 **/
@Configuration
@MapperScan(basePackages = "top.tangtian.geek_week0701.mapper.slave", sqlSessionFactoryRef = "slaveSqlSessionFactory")
public class SlaveMybatisConfig {
    ...
    public SqlSessionFactory masterSqlSessionFactory(@Qualifier("slave") DataSource dataSource) throws Exception {
        ...
        //对应数据库的entity位置
        String typleAliasesPackage = "top.tangtian.geek_week0701.entity.slave";
